				...
				border.setOnMouseClicked(new EventHandler<MouseEvent>() {
					public void handle(MouseEvent me) {
						...
						try {
							...
							label.setText("The score for white " + controller.white_score() + " The score for black "
									+ controller.black_score());
							...
							if (SC == 'C')
								color = 1;// client color is black
							System.out.println("This is not valid move");
							if (controller.checkAllPossible(color) == 1) {
								if (SC == '?')
									controller.computerTurn();
								label.setText("The score for white " + controller.white_score()
										+ " The score for black " + controller.black_score());
								if (controller.checkAllPossible(0) == 1 && controller.checkAllPossible(1) == 1) {
									display();
	...
	public void start(Stage primaryStage) {
		...
		item2.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent me) {
				...
				d.make_stage(new EventHandler<MouseEvent>() {
								...
								try {
									...
									while (killThread) {
										...
										Platform.runLater(() -> {
											...
											if (controller.checkAllPossible(0) == 1
													&& controller.checkAllPossible(1) == 1) {
		...
		label.setText(
				"The score for white " + controller.white_score() + " The score for black " + controller.black_score());
